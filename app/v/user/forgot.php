...
<link href="<?php echo BASE?>static/default.css" rel="stylesheet" type="text/css" media="screen" />
  <script charset="utf-8" src="<?php echo BASE?>static/jquery-1.7.1.min.js"></script>
</head>
<body>
...
输入你登录用 email 帐号   </li>
   ...
   <li >
	 <input class="medium" required name="username" placeholder="email" type="text"  value="<?php echo isset($val['username'])?$val['username']:''?>" />
   </li>
  <li>
